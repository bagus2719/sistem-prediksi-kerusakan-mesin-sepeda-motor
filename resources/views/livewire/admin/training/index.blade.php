<div>
    ...
    <div class="flex items-center justify-end gap-3 mb-6 flex-wrap">
        <a href="{{ route('admin.export.training') }}" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl text-base font-bold shadow-sm flex items-center gap-2 transition-colors">
